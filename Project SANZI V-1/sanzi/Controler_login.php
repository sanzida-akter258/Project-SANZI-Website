...
<html lang="en">
  <head>
    ...
    <style>
        ...
        .admin_login_box{
          ...
          padding: 12px;
          padding-top: 15px;
          box-shadow: 5px 5px 10px #a19a9a,-5px 5px 10px #a19a9a,5px -5px 10px #a19a9a,-5px -5px 10px #a19a9a;
        }
        .admin_login_box form input{
          width: 90%;
          height: 50px;
          padding: 6px;
          border: none;
        ...
        .submit_button{
          background-color: rgb(23, 107, 12);
          color: #fff;
  ...
  <body>
    ...
    <!-- Controller Login Section Start-->
            ...
            <div class="row">
              ...
              <div class="col-md-4 text-center justify-content-center ">
                <div class="admin_login_box">
                  <h1>Hello Crontroler !!</h1>
                   <form action="assets/php/controler_login.php" method="Post">
                      <input type="text" name="controler_email" id="" placeholder="Controler Email">
                      <input type="password" name="controler_password" id="" placeholder="Controler Password">
    ...
    <!--Controller Login Section Start end-->
